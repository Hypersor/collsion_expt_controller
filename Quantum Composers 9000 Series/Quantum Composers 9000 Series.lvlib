...
<Library LVVersion="19008000">
	...
	<Property Name="NI.Lib.Icon" Type="Bin">'1#!!!!!!!)!"1!&amp;!!!-!%!!!@````]!!!!"!!%!!!*#!!!*Q(C=\:1^=C*"$%9`NDSVG]Y.8)2/&gt;17OQ"6U"6*#5G@I!!3?+R![V27Y!F?9@&gt;-D\RJ="9F&gt;N6PF&lt;A1TH^43[R^;;OW8^+$R8ONONMH@9O&lt;!$_%)5U1X[`8YNV`\7\WR?W=8`L=5&amp;`\L_N@ZO_\'(-:2.^OX`^P`@`PP.'+W&gt;Y/_O%G,2IIF&amp;JBDVG9X*HKC*XKC*XKC"XKA"XKA"XKA/\KD/\KD/\KD'\KB'\KB'\KBNYYO&gt;+%,H66*CC?&amp;EK2*AC19&amp;#6@#5`#E`!E0,QKY5FY%J[%*_%B2!F0QJ0Q*$Q*$]/5]#1]#5`#E`#1KJ&amp;E[_DQ*$SE6]!4]!1]!5`!1UE&amp;0!&amp;!5#R)(#1"1Y%T?!BY!J[!BU=&amp;0!&amp;0Q"0Q"$SY&amp;@!%0!&amp;0Q"0Q-+3N3D3;K;0$1RIZ0![0Q_0Q/$SEFM0D]$A]$I`$1TEZ0![0!_%5&gt;*+$)'?1%_#]/$Q/$T^S?"Q?B]@B=8BQN2XSND)4T&gt;42Y4&amp;Y$"[$R_!R?%ABA]@A-8A-(I/(N$*Y$"[$R_!R?#AFA]@A-8A-%+-IZ75E-Q9;19:A]0"JJ]8;,E5DM&gt;&lt;LLTE@6.5"6"UMV9&amp;2(146"KMW4L5BKI67,;"K96146EV%";AKL%KI#N3:\R.WR!:MBWWQ.&lt;&lt;#FFA`$@XEQ00ZL.0JJ/0RK'%9N.PNN.FMN&amp;[PN6KNN&amp;QOV@@^H^PKE4[XR&gt;O^N/6Z`[L&amp;Y7&amp;Y/@R]\A^[\P?P4S]58'S`U/:\[6_Y'`6$Y\NLHD8[$4C`,R%!!!!!</Property>
	...
	<Item Name="Public" Type="Folder">
		...
		<Item Name="Action-Status" Type="Folder">
			<Item Name="Low Level" Type="Folder">
				...
				<Item Name="Get Sys (To) Period.vi" Type="VI" URL="/&lt;instrlib&gt;/Quantum Composers 9000 Series/Public/Action-Status/Low Level/Get Sys (To) Period.vi"/>
				<Item Name="Get State.vi" Type="VI" URL="/&lt;instrlib&gt;/Quantum Composers 9000 Series/Public/Action-Status/Low Level/Get State.vi"/>
			</Item>
			...
			<Item Name="Query Sys (To) Parameters (Input).vi" Type="VI" URL="/&lt;instrlib&gt;/Quantum Composers 9000 Series/Public/Action-Status/Query Sys (To) Parameters (Input).vi"/>
			<Item Name="Query Sys (To) Parameters (Mode).vi" Type="VI" URL="/&lt;instrlib&gt;/Quantum Composers 9000 Series/Public/Action-Status/Query Sys (To) Parameters (Mode).vi"/>
			<Item Name="Query Sys (To) Parameters.vi" Type="VI" URL="/&lt;instrlib&gt;/Quantum Composers 9000 Series/Public/Action-Status/Query Sys (To) Parameters.vi"/>
		...
		<Item Name="Configure" Type="Folder">
			<Item Name="Low Level" Type="Folder">
				...
				<Item Name="Configure Sys (To) Period.vi" Type="VI" URL="/&lt;instrlib&gt;/Quantum Composers 9000 Series/Public/Configure/Low Level/Configure Sys (To) Period.vi"/>
			</Item>
			...
			<Item Name="Configure Chan Output.vi" Type="VI" URL="/&lt;instrlib&gt;/Quantum Composers 9000 Series/Public/Configure/Configure Chan Output.vi"/>
			<Item Name="Configure Sys (To) Input.vi" Type="VI" URL="/&lt;instrlib&gt;/Quantum Composers 9000 Series/Public/Configure/Configure Sys (To) Input.vi"/>
			<Item Name="Configure Sys (To) Mode.vi" Type="VI" URL="/&lt;instrlib&gt;/Quantum Composers 9000 Series/Public/Configure/Configure Sys (To) Mode.vi"/>
			<Item Name="Configure Sys (To) Mode (Burst).vi" Type="VI" URL="/&lt;instrlib&gt;/Quantum Composers 9000 Series/Public/Configure/Configure Sys (To) Mode (Burst).vi"/>
			<Item Name="Configure Sys (To) Mode (Duty Cycle).vi" Type="VI" URL="/&lt;instrlib&gt;/Quantum Composers 9000 Series/Public/Configure/Configure Sys (To) Mode (Duty Cycle).vi"/>
			<Item Name="Configure Sys (To) Mode (Normal).vi" Type="VI" URL="/&lt;instrlib&gt;/Quantum Composers 9000 Series/Public/Configure/Configure Sys (To) Mode (Normal).vi"/>
			<Item Name="Configure Sys (To) Mode (Single Shot).vi" Type="VI" URL="/&lt;instrlib&gt;/Quantum Composers 9000 Series/Public/Configure/Configure Sys (To) Mode (Single Shot).vi"/>
		...
		<Item Name="Utility" Type="Folder">
			...
			<Item Name="Recall-Save Memory.vi" Type="VI" URL="/&lt;instrlib&gt;/Quantum Composers 9000 Series/Public/Utility/Recall-Save Memory.vi"/>
